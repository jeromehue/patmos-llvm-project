...
//
//===----------------------------------------------------------------------===//
#ifndef PATMOSSTACKCACHEANALYSIS2
#define PATMOSSTACKCACHEANALYSIS2

#include "Patmos.h"
#include "llvm/Target/TargetMachine.h"
namespace llvm {

class PatmosStackCacheAnalysisInfo2 : public ImmutablePass {
  bool Valid;

public:
  PatmosStackCacheAnalysisInfo2(const TargetMachine &TM) : ImmutablePass(ID),
    Valid(false) {
      initializePatmosStackCacheAnalysisInfo2Pass(*PassRegistry::getPassRegistry());
    }

  PatmosStackCacheAnalysisInfo2()
